...
## Update: Excel-nahe Admin-Regelpflege

Die Admin-Oberfläche folgt nun stärker der Regel-Excel-Struktur: Stammdaten, Pre-Conditions, Trigger-Conditions, Action/Funktion, Post-Conditions und Next-Step. Der zentrale Katalog heißt `Wissensbausteine`; Conditions entstehen erst in der Regelverwaltung.

Importierte Referenzdateien:

- `Rule Engine/technical/Regeln_vollständig_neu.xlsx`
- `Rule Engine/technical/regeln_vollstaendig_neu_condition_catalog.json`
- `Rule Engine/technical/regeln_vollstaendig_neu_functions.json`
- `Rule Engine/technical/regeln_vollstaendig_neu_rule_overview.json`
- `Rule Engine/technical/regeln_vollstaendig_neu_translation_matrix.json`
- `Rule Engine/technical/regeln_vollstaendig_neu_priorities.json`

Die technische JSON-Vorschau bleibt erhalten und kann über `Admin · Technische JSON-Dateien` kontrolliert werden.
