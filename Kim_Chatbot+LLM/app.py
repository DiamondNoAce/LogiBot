...
def main() -> None:
    ...
    top_nav = {
        ...
        "Conditions/Facts": "Admin: Conditions / Facts",
        "Funktionen": "Admin: Funktionen & Antworten",
        "Regeln": "Admin: Regelverwaltung",
        "Abläufe": "Admin: Abläufe",
        "Netz": "Admin: Entscheidungsnetz",
    ...
    elif view == "Admin: Conditions / Facts":
