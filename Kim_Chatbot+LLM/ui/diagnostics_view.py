...
def admin_tests_diagnostics(
    ...
    st.markdown('<div class="hero-title">Tests & Diagnose</div>', unsafe_allow_html=True)
    st.markdown(
        '<div class="hero-subtitle">Technische Prüfwerkzeuge für Admins, Projektteam und Entwicklung. Normale Nutzer sehen diese Debug-Informationen nicht.</div>',
